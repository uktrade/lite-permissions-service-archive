...
public class FailServiceImpl implements FailService {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(FailServiceImpl.class);
  ...
  @Inject
  public FailServiceImpl(OgelSubmissionDao submissionDao, @Named("maxMinutesRetryAfterFail") int maxMinutesRetryAfterFail) {
